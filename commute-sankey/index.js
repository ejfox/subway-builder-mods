...
(function () {
    ...
    if (!api) {
        console.error('[Commute Sankey] API not available');
        return;
    }
    ...
    if (!charts || !charts.Sankey) {
        console.error('[Commute Sankey] Sankey chart not available');
        api.ui.showNotification('Commute Sankey: Charts not available', 'error');
        return;
    }
    ...
    /**
     * Main Sankey visualization component
     */
    ...
    if (api.ui.addToolbarPanel) {
        ...
        function SankeyButton() {
            ...
            return h(React.Fragment, null, [
                ...
                }, h(GitBranch, { className: 'w-full h-full stroke-[1.5]' })),
                isOpen && h('div', {
                    key: 'backdrop',
        ...
        api.ui.registerComponent('top-bar', {
            id: 'commute-sankey',
            component: SankeyButton,
        });
    }

    api.ui.showNotification('Commute Sankey loaded!', 'success');
    console.log('[Commute Sankey] Loaded');
})();
